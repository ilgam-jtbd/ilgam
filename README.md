...
> "일"(Work) + "감"(感, 감각·보람). 베이비부머 2차(1964~1974년생, 954만명)를 AI 청년 세대와 융합하는 세대통합·ESG 기반 스팟워크 플랫폼.

## 포지셔닝

- 레퍼런스: 타이미(Timee, 일본 2024 도쿄증시 상장, 워커 1,100만명+, 수수료 30%)
- 수수료율: 15~20% (보수적 설계, M1 워커 0% · 구인자 15% 시작)
- 경쟁 2축: 급구(니더, 부산, 브릿지 80억) · 당근알바(MAU 2,100만)
- 진입 창문: 9~12개월 (급구 브릿지 자본 소진 가속 페이즈 기준)
